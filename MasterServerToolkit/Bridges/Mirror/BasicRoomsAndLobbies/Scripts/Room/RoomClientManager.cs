...
namespace MasterServerToolkit.Bridges.MirrorNetworking
{
    public class RoomClientManager : RoomClient<RoomClientManager>
    {
        ...
        public delegate void Load_OffLine();
        public static event Load_OffLine load_Offline;
        ...
        /// <summary>
        /// Invoked when client connected to room server || RoomNetworkManager / OnClientConnect to here
        /// </summary>
        /// <param name="conn"></param>
        protected virtual void Manager_OnConnectedEvent(NetworkConnection conn)
        {
            logger.Info("Room client has just joined a room server"); // Rejoin Game Miss this ?
        ...
        protected virtual void LoadOnlineScene()
        {
            ...
            () =>
            {
                ...
                if (RoomNetworkManager.autoCreatePlayer && NetworkClient.localPlayer == null)
                {
                    Debug.Log("LoadOnlineScene || NetworkClient.localPlayer == null || " + NetworkClient.localPlayer == null);
