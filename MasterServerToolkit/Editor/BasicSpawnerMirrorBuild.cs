...
namespace MasterServerToolkit.MasterServer.Examples.BasicSpawnerMirror
{
    public class BasicSpawnerMirrorBuild
    {
        ...
        private static void BuildRoomForWindows(bool isHeadless)
        {
            ...
            {
                scenes = new[] {
                    "Assets/Scenes/01_Battle_Start.unity",
                    "Assets/Scenes/02_Battle_Scene.unity"
                },
            ...
            if (summary.result == BuildResult.Succeeded)
            {
                ...
                properties.Add(Mst.Args.Names.OP_Code, Mst.Args.OP_Code);
        ...
        private static void BuildClientForWindows()
        {
            ...
            {
                scenes = new[] {
                    "Assets/Scenes/00_Login_Scene.unity",
                    "Assets/Scenes/01_Battle_Start.unity",
                    "Assets/Scenes/02_Battle_Scene.unity"
                },
            ...
            if (summary.result == BuildResult.Succeeded)
            {
                ...
                Debug.Log("Mst.Args.Names.MasterIp " + Mst.Args.Names.MasterIp + " || " + Mst.Args.Names.MasterPort);
