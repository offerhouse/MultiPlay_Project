...
namespace MasterServerToolkit.MasterServer
{
    public class SpawnerController : ISpawnerController
    {
        ...
        {
            short OP_Code = data.CustomOptions.AsShort("OP_Code");
            UnityEngine.Debug.Log("SpawnRequestHandler || " + OP_Code);
            ...
            /************************************************************************/
            // Create custom OP_Code
            processArguments.Set(Mst.Args.Names.OP_Code, data.CustomOptions.AsShort("OP_Code"));
