...
namespace MasterServerToolkit.MasterServer
{
    ...
    public class ObservableProfile : IEnumerable<IObservableProperty>, IDisposable
    {
        ...
        /// <summary>
        /// Invoked, when all of the values changes finish
        /// </summary>
        ...
        public void ReadUpdates(EndianBinaryReader reader)
        {
            ...
            UnityEngine.Debug.Log("dataRead.count || " + count);
            // Update observables
            ...
            UnityEngine.Debug.Log("Update_Finish ?");
            Update_Add_Property_Finish_Event?.Invoke();
        }
