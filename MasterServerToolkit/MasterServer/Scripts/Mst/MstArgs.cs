...
namespace MasterServerToolkit.MasterServer
{
    public class MstArgs
    {
        ...
        public short OP_Code { get; private set; }
        ...
        public MstArgs()
        {
            ...
            MasterIp = AsString(Names.MasterIp, "192.168.0.100");
            ...
            RoomIp = AsString(Names.RoomIp, "192.168.0.100");
        ...
        /// <returns></returns>
        public short AsShort(string argName, short defaultValue = -1)
        {
            try
            {
                var value = AsString(argName, defaultValue.ToString());
